        ...
        if (colmodel) {
            ...
            for (var i = 0; i < colmodel.length; i++) {
                ...
                if (i < colmodel.length - 1) {
                    theaderstr += '<th class="text-' + algin + hideinxsclass + '" width="' + width + '">';
                }
                else {
                    theaderstr += '<th class="text-' + algin + hideinxsclass + '">';
                }
                        ...
                        if (context.rows.length > 0) {
                            for (var i = 0; i < context.rows.length; i++) {
                                ...
                                $.each(context.rows[i], function (k, v) {
                                    ...
                                    trstring += '<td class="text-' + algin + hideinxsclass + '">';
                                    if (setting.colmodel[j].formatter) {
                                        trstring += setting.colmodel[j].formatter.call($tbody, v);
                                    }
                                    else {
                                        trstring += v;
                                    }
